...
def save_inference_samples(runs_dir, data_dir, sess, image_shape, logits, keep_prob, input_image, output_dir_name):
	"""
    ...
    :param output_dir_name output folder name
	"""
	# Make folder for current run
	output_dir = os.path.join(runs_dir, output_dir_name)
	if os.path.exists(output_dir):
		shutil.rmtree(output_dir)
	os.makedirs(output_dir)

	# Run NN on test images and save them to HD
	print('Training Finished. Saving test images to: {}'.format(output_dir_name))
